    ...
    id='resume'>
      ...
      <div className='cursor-default'>
        ...
        <section className='resume-container flex flex-col ml-2'>
          {/* 2023-present */}
          <motion.div
            className='resume-item relative pl-[74px] pb-[40px] sm:pb-[68px] text-[#999999] hover:text-[#28e98c] transition-all duration-[0.3] ease-in-out'
            initial={{ x: 100, opacity: 0 }}
            whileInView={{ x: 0, opacity: 1 }}
            transition={{ duration: 0.8, type: 'easeInOut', delay: 0.2 }}
            viewport={{ margin: '-80px 0px' }}
          >
            <div className='text-xs sm:text-base pb-[15px] sm:pb-[28px] cursor-default'>2023 - Present</div>
            <h4 className='text-white text-lg sm:text-2xl mb-[5px]'>Fullstack Developer</h4>
          ...
          <motion.div
            ...
            viewport={{ margin: '-80px 0px' }}
          >
            <div className='text-xs sm:text-base pb-[15px] sm:pb-[28px] cursor-default'>2020-2022</div>
            <h4 className='text-white text-lg sm:text-2xl mb-[5px]'>Frontend Developer</h4>
          ...
          <motion.div
            ...
            viewport={{ margin: '-80px 0px' }}
          >
            <div className='text-xs sm:text-base pb-[15px] sm:pb-[28px] cursor-default'>2012-2020</div>
            <h4 className='text-white text-lg sm:text-2xl mb-[5px]'>Master of Science in Internetworking</h4>
            <p className='text-[#999999] text-xs mb-[18px]'>UTS</p>
            <h4 className='text-white text-lg sm:text-2xl mb-[5px]'>Bachelor of Computer science in Gaming</h4>
