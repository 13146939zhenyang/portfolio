...
const Portfolio = () => {
  return (
    <div className='w-screen text-white pt-[70px] pl-[40%]' id='portfolio'>
      ...
      <div className='mb-16'>
        <motion.div
          className='w-[770px] h-[410px] mb-[30px] rounded-[30px] shadow-lg overflow-hidden'
      ...
      <div className='mb-16 flex flex-row items-center justify-start gap-6'>
        ...
        <div className=''>
          <motion.div
            className='w-[373px] mb-[30px] rounded-[30px] shadow-lg overflow-hidden'
            initial={{ y: 80, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ duration: 1.5, type: 'spring', bounce: 0.2, delay: 0.3 }}
            viewport={{ margin: '-100px 0px' }}
        ...
        {/* p3 */}
        <div className=''>
          <motion.div className='w-[373px] mb-[30px] rounded-[30px] shadow-lg overflow-hidden'
            initial={{ x: 80, y: 80, opacity: 0 }}
            whileInView={{ x: 0, y: 0, opacity: 1 }}
            transition={{ duration: 1.5, type: 'spring', bounce: 0.2, delay: 0.3 }}
            viewport={{ margin: '-100px 0px' }}>
      ...
      {/* project 4 */}
      <div className='mb-16'>
        <motion.div className='w-[770px] h-[410px] mb-[30px] rounded-[30px] shadow-lg overflow-hidden' initial={{ y: 80, opacity: 0 }}
          whileInView={{ y: 0, opacity: 1 }}
          transition={{ duration: 1.5, type: 'spring', bounce: 0.2, delay: 0.3 }}
          viewport={{ margin: '-100px 0px' }}>
          <picture>
      ...
      <div className='mb-16 flex flex-row items-center justify-start gap-6'>
        {/* p5 */}
        <div className=''>
          <motion.div className='w-[373px] mb-[30px] rounded-[30px] shadow-lg overflow-hidden' initial={{ y: 80, opacity: 0 }}
            whileInView={{ y: 0, opacity: 1 }}
            transition={{ duration: 1.5, type: 'spring', bounce: 0.2, delay: 0.3 }}
            viewport={{ margin: '-100px 0px' }}>
            <picture>
